...
public class CameraEffects : MonoBehaviour
{
    ...
    /// Do the shake
    /// </summary>
    public static void ShakeOnce(float duration = 1f, float speed = 15f, Vector3? amount = null, Camera camera = null, bool deltaMovement = true, AnimationCurve curve = null)
    {
        //set data
